...
const App = () => {
    ...
    useEffect(() => {
        const handleSession = async (session) => {
            ...
            if (profileError || !profile) {
                ...
                // Remove spaces and special characters for a clean username
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            setSubmissionMessage(`Google login failed: ${err.message}`);
            setIsLoading(false);
        }
    };
            ...
            <div className={`relative flex justify-center items-center min-h-screen p-4 font-sans ${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-gradient-to-br from-indigo-500 to-purple-600'}`}>
                ...
                <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl text-center max-w-md w-full transition-colors duration-200">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full flex items-center justify-center gap-3 p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
